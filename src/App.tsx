    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="metier" element={<ProtectedRoute><div>Dashboard Metier</div></ProtectedRoute>} />
          <Route path="metier/portefeuille" element={<ProtectedRoute><div>Portefeuille</div></ProtectedRoute>} />
