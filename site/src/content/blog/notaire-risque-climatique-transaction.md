---
title: "Notaire : integrer le risque climatique dans une transaction immobiliere"
description: "Trois moments cles ou le risque climatique doit etre pris en compte par le notaire, au-dela de la simple conformite ERP."
pubDate: 2026-06-15
author: "Hubert Roche"
persona: ["notaire"]
...
## Avant la signature : verifier la fraicheur des donnees

Un ERP valide juridiquement peut s'appuyer sur des donnees perimees, notamment depuis la revision de la carte RGA en juillet 2026. Un bien classe en zone faible il y a un an peut aujourd'hui entrer dans une zone d'exposition plus elevee. Une verification a jour evite un litige post-vente.

## Pendant la negociation : objectiver la decote

Quand un risque climatique est identifie, la question de son impact sur le prix se pose souvent de maniere subjective, au gre des parties. Un diagnostic chiffre et methodologique — plutot qu'une estimation a l'instinct — facilite un accord equilibre entre vendeur et acquereur.

## Apres la vente : anticiper les obligations futures

Pour les biens a usage professionnel, le Decret Tertiaire ou la CSRD peuvent imposer des obligations de renovation a l'acquereur. Signaler ce point en amont evite les mauvaises surprises et positionne le notaire comme un conseiller complet.

Notre solution AGEprevention est concue pour s'integrer a ce moment precis du parcours : un diagnostic mobilisable des la phase de negociation, avec un rapport exploitable par toutes les parties.